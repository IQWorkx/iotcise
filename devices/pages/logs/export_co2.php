...
$exp = mysqli_query($iot_db,"SELECT co2,DATE_FORMAT(create_date, '%d-%M-%Y %H:%i') as create_date FROM `live_data` WHERE `device_id` = '$device_id' and create_date >= '$datefrom' and create_date <= '$dateto' order by create_date desc");
$header = "CO2 Value" . "\t" . "Date" . "\t";
