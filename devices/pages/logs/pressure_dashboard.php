            ...
            <div class="mdc-layout-grid">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-8-tablet">
                    <div class="mdc-card">
                        ...
                        <form action="export_pressure.php" method="post" id="export_excel">
    ...
    function saveAsPDF() {
        html2canvas(document.getElementById("chart-container"), {
            onrendered: function(canvas) {
                ...
                doc.save('<?php echo $device_name; ?>_pressure.pdf');
            }
        });
    }
</script>
...
<script>
    ...
    $.ajax({
        type: "POST",
        url: "../../../devices/schedular/livedata.php?p_id=3&&device_id=<?php echo $_GET['id']; ?>",
        data: data,
        success : function(data){
            ...
            for(var i in data)
            {
                ...
                pressure_follower.push(data[i].pressure);
                pressure_upp.push(data[i].upper_tolerance);
