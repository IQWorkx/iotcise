                            ...
                            <div class="panel-body table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" name="edit_is_active" id="edit_is_active" value="<?php echo $rowc["device_id"]; ?>" <?php echo ($rowc['is_active']==1 ? 'checked' : '');?>
