    ...
    if($rowv1 == true){
        if($tmp_high_email != 1)
        {
            if($temperature > $temp_upper_tolerance){
                ...
                $message2 = "Upper Tolerance Value : " . $temperature;
                $message3 = "Actual Value  : " . $temp_upper_tolerance;
        ...
        if($tmp_low_email != 1)
        {
            if($temperature < $temp_lower_tolerance){
                ...
                $message2 = "Lower Tolerance Value : " . $temperature;
                $message3 = "Actual Value  : " . $temp_lower_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
    ...
    if($rowv3 == true){
        if($hum_high_email != 1)
        {
            if($humidity > $hum_upper_tolerance){
                ...
                $message2 = "Upper Tolerance Value : " . $humidity;
                $message3 = "Actual Value  : " . $hum_upper_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
        ...
        if($hum_low_email != 1)
        {
            if($humidity < $hum_lower_tolerance){
                ...
                $message2 = "Lower Tolerance Value : " . $humidity;
                $message3 = "Actual Value  : " . $hum_lower_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
    ...
    if($rowv4 == true){
        if($pre_high_email != 1)
        {
            if($pressure > $pre_upper_tolerance){
                ...
                $message2 = "Upper Tolerance Value : " . $pressure;
                $message3 = "Actual Value  : " . $pre_upper_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
        ...
        if($pre_low_email != 1)
        {
            if($pressure < $pre_lower_tolerance){
                ...
                $message2 = "Lower Tolerance Value : " . $pressure;
                $message3 = "Actual Value  : " . $pre_lower_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
    ...
    if($rowv5 == true){
        if($iaq_high_email != 1)
        {
            if($iaq > $iaq_upper_tolerance){
                ...
                $message2 = "Upper Tolerance Value : " . $iaq;
                $message3 = "Actual Value  : " . $iaq_upper_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
        ...
        if($iaq_low_email != 1)
        {
            if($iaq < $iaq_lower_tolerance){
                ...
                $message2 = "Lower Tolerance Value : " . $iaq;
                $message3 = "Actual Value  : " . $iaq_lower_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
    ...
    if($rowv6 == true){
        if($voc_high_email != 1)
        {
            if($voc > $voc_upper_tolerance){
                ...
                $message2 = "Upper Tolerance Value : " . $voc;
                $message3 = "Actual Value  : " . $voc_upper_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
        ...
        if($voc_low_email != 1)
        {
            if($voc < $voc_lower_tolerance){
                ...
                $message2 = "Lower Tolerance Value : " . $voc;
                $message3 = "Actual Value  : " . $voc_lower_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
    ...
    if($rowv7 == true){
        if($co2_high_email != 1)
        {
            if($co2 > $co2_upper_tolerance){
                ...
                $message2 = "Upper Tolerance Value : " . $co2;
                $message3 = "Actual Value  : " . $co2_upper_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
        ...
        if($co2_low_email != 1)
        {
            if($co2 < $co2_lower_tolerance){
                ...
                $message2 = "Lower Tolerance Value : " . $co2;
                $message3 = "Actual Value  : " . $co2_lower_tolerance;
                $message4 = "Device Name : " . $device_name;
                $message5 = "Type : " . $dev_type_name;
                $message6 = "Location : " . $device_location;
                $message7 = "Description : " . $device_description;
